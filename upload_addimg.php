...
$stdid_latest = getStd_id($username);
$img_count = countimagesStd($stdid_latest);
error_log ("username passes: " . $username . "\n");

$img_count++;

$fileName = "{$username}{$img_count}.jpg";
...
error_log ("Student Name: " . $username . "\n");
...
$username = escapeshellarg($username); // Use the student's name here
$img_path = escapeshellarg($filePath);

$command = "$python_path $python_script_path $stdid_latest $username $img_path";
